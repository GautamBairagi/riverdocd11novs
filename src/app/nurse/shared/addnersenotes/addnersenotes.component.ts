...
@Component({
  selector: 'app-addnersenotes',
  templateUrl: './addnersenotes.component.html',
  styleUrls: ['./addnersenotes.component.css']
})
export class AddnersenotesComponent implements OnInit {
